...
export const staffData = {
    ...
    15: { id: 15, nameUr: 'جواد سومرو', nameEn: 'Jawad Soomro', roleUr: 'سوشل میڈیا — موسیٰ لائن', roleEn: 'Social Media — Musa Line', entryTime: '11:00 AM', exitTime: '1:30 PM', entryHour: 11, exitHour: 13.5, totalHours: 2.5, salary: 10000, perDaySalary: Math.round(10000 / 26), perHourSalary: Math.round(10000 / 26 / 2.5), perMinuteSalary: 10000 / 26 / 2.5 / 60, phone: '03112077842', email: 'jawadsoomrowork@gmail.com', city: 'Karachi', country: 'Pakistan', joinDate: '2019', setupDate: '2026-04-15', setupComplete: true },
