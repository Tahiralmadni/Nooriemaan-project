...
export const staffData = {
    ...
    15: { id: 15, nameUr: 'محمد کاشف عطاری', nameEn: 'Muhammad Kashif Attari', roleUr: '-', roleEn: '-', entryTime: '-', exitTime: '-', entryHour: 0, exitHour: 0, totalHours: 0, salary: 0, perDaySalary: 0, perHourSalary: 0, perMinuteSalary: 0, phone: '-', email: '-', city: 'Karachi', country: 'Pakistan', joinDate: '-', setupDate: '', setupComplete: false },
    ...
    19: { id: 19, nameUr: 'احمد شاہ', nameEn: 'Ahmed Shah', roleUr: '-', roleEn: '-', entryTime: '-', exitTime: '-', entryHour: 0, exitHour: 0, totalHours: 0, salary: 0, perDaySalary: 0, perHourSalary: 0, perMinuteSalary: 0, phone: '-', email: '-', city: 'Karachi', country: 'Pakistan', joinDate: '-', setupDate: '', setupComplete: false },
