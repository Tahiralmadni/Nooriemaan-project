        ...
        <>
            ...
            >
                ...
                <div className="mx-4 space-y-2.5 pb-8">
                    {[
                        { icon: Phone, label: t('profile.phoneNumber'), value: staff.phone, accent: '#3b82f6', isPhone: true },
                        ...
                        <motion.div
                            ...
                            className="bg-white dark:bg-slate-800 rounded-xl p-3.5 border border-gray-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow flex items-center gap-3 relative overflow-hidden"
                        >
                            <div
                            ...
                            {item.isPhone && item.value && item.value !== '-' && (
                                <a
                                    href={`https://wa.me/${item.value.replace(/\D/g, '')}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-emerald-500 hover:bg-emerald-600 text-white p-2 rounded-lg transition-transform hover:scale-110 shadow-sm"
                                    title="WhatsApp"
                                >
